...
By default, PeppersCore Core allows up to 125 connections to different peers, 8 of
...
limits are tiny. Keep in mind that pepperscore's trustless model works best if you are
