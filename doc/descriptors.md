# Support for Output Descriptors in PeppersCore Core

Since PeppersCore Core v0.17, there is support for Output Descriptors. This is a
...
on PeppersCore's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing PeppersCore Core wallets, a convenience function `combo` is
