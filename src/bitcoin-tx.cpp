...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " pepperscore-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  pepperscore-tx [options] <hex-tx> [commands]  Update hex-encoded pepperscore transaction\n" +
            "or:     pepperscore-tx [options] -create [commands]   Create hex-encoded pepperscore transaction\n" +
            "\n";
