...
"""Verify that starting pepperscore with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start pepperscore with -h for help text")
        ...
        self.log.info("Start pepperscore with -version for version information")
        ...
        self.log.info("Start pepperscored with -fakearg to make sure it does not start")
